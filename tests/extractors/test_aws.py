...
from statement_renamer.extractors.aws import AWSDateExtractor as EXTRACTOR_UNDER_TEST
...
TESTDATA = (
    ...
    'Account number:************Bill to Address:ATTN: Homer J. Simpson742 Evergreen TerraceSpringfield , IA , 01234 , US'
